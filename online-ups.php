...
<head>
    ...
    <title>Service DESK | Online UPS</title>
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="active-item"><a href="online-ups.php"><i class="fa fa-home" aria-hidden="true"></i><span>Online UPS</span></a></li>
                                <li class="close-item"><a href="add-asset.php"><i class="fa fa-plus" aria-hidden="true"></i><span>Add Asset</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                ...
                <div class="content-header">
                    ...
                    <div class="leftside-content-header">
                        <ul class="breadcrumbs">
                            ...
                            <li><i class="fa fa-home" aria-hidden="true"></i><a href="online-ups.php">Online UPS</a></li>
                        </ul>
                    </div>
                </div>
                <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
